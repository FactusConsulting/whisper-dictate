...
| `VOICEPI_TOGGLE=1` | toggle mode (env only): **press** the hotkey to start recording, **press again** to stop and transcribe — instead of holding it. Key autorepeat is ignored (rising-edge only); restart-only. |
