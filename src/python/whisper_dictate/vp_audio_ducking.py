...
Off by default and only implemented on Windows (pycaw, imported lazily). An
atexit hook plus the active-ducker registry guarantee volumes are restored on
exit. Extracted from runtime.py to keep the runtime module focused.
"""
