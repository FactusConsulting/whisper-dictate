...
from whisper_dictate.vp_corpus import annotate_event, load_corpus, skipped_event
from whisper_dictate.vp_device import _resolve_device
...
def _run_loaded_model(audio_file: str | Path, item: Any | None, spec: BackendSpec,
    ...
    from whisper_dictate.vp_file_transcribe import transcribe_file_event
