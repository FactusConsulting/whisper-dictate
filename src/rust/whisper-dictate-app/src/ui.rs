    ...
    fn label(self, language: UiLanguageMode) -> &'static str {
        match language {
            UiLanguageMode::English => match self {
                ...
                UiTextKey::Messages => "Messages",
                UiTextKey::NoMessages => "No messages",
            ...
            UiLanguageMode::Danish => match self {
                ...
                UiTextKey::Messages => "Beskeder",
                UiTextKey::NoMessages => "Ingen beskeder",
...
fn ui_text(raw_language: &str, key: UiTextKey) -> &'static str {
    key.label(UiLanguageMode::from_raw(raw_language))
}

fn runtime_state_label(state: RuntimeState, raw_language: &str) -> &'static str {
    match state {
